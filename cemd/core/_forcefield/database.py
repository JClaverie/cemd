...
"""
Force field database loader from TOML files.
"""
...
class ForceFieldDatabase:
    ...
    def __init__(self, db_dir: Path = None):
        self.db_dir = Path(db_dir) if db_dir else FF_DATABASE_DIR
    ...
    def _load_all(self) -> None:
        ...
        # Métadonnées
        metadata_path = self.db_dir / "_metadata.toml"
        ...
        # Fichiers TOML
        for toml_path in self.db_dir.glob("*.toml"):
