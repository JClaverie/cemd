...
class ParseResult:
    ...
    bonds: dict[str, HarmonicBondParams | Class2BondParams] = field(default_factory=dict)
    angles: dict[str, HarmonicAngleParams | Class2AngleParams] = field(default_factory=dict)
    impropers: dict[str, HarmonicImproperParams | DistanceImproperParams] = field(default_factory=dict)
