...
def plot_XOH_X(list_properties):
    ...
    plt.plot(
        x_Ca_Si, y_CaOH, "--", color=colors[0], alpha=1, label="Ca-OH/Ca (exp)", lw=lw
    )
    plt.plot(
        x_Ca_Si, y_SiOH, "--", color=colors[1], alpha=1, label="Si-OH/Si (exp)", lw=lw
    )
