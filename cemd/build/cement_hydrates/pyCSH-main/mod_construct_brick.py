            ...
            for i in range(self.N_atom):
                ...
                if specie == "Ow":
                    ...
                    if random_water:
                        ...
                        v[2] = (
                            np.cos(104 * np.pi / 180) - u[0] * v[0] - u[1] * v[1]
                        ) / u[2]
                        v = v / np.linalg.norm(v)
...
class Brick:
    def __init__(self, comb, pieces, ind):
        ...
        self.elegible_water = np.array(
            sorted(list(list_water.difference(self.excluded)))
        )
                ...
                for i_right in [["<R"], ["<Ro"]]:
                    for oh_bridge_1 in [[None], ["oMUL"]]:
                        for oh_bridge_2 in [[None], ["oMUR"]]:
                            comb = (
                                i_left + i_bridge + oh_bridge_1 + oh_bridge_2 + i_right
                            )
                            ...
                            for i_OH_2 in inter_OH_2:
                                for i_OH_3 in inter_OH_3:
                                    for i_OH_4 in inter_OH_4:
                                        ...
                                        inter_OH_5 = [None]
                                        if i_Ca_2 == "XU":
                                            inter_OH_5.append("oXU")
                                        if i_Ca_3 == "XD":
                                            inter_OH_5.append("oXD")
