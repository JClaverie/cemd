...
from cemd.gui.ui.builders import (
    SolutionDialog, 
    SurfaceDialog, 
...
def on_protonate(parent: AtomViewerGUI) -> None:
    ...
    try:
        ...
        from cemd.builders.base import protonate
        for real_id in indices:
            iloc_idx = system.atoms.index.get_loc(real_id)
            protonate(system, iloc_idx)
